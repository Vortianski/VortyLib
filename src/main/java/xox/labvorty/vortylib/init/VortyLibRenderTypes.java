...
@OnlyIn(Dist.CLIENT)
public class VortyLibRenderTypes extends RenderStateShard {
    static ResourceLocation DEBUG_TEXTURE = ResourceLocation.fromNamespaceAndPath("minecraft", "textures/block/debug.png");

    public VortyLibRenderTypes(String name, Runnable setupState, Runnable clearState) {
    ...
    private static RenderType createTextNoCull(ResourceLocation resourceLocation) {
        RenderType.CompositeState compositeState = RenderType.CompositeState.builder()
                ...
                .setTextureState(new CustomizableTextureState(resourceLocation, () -> ForgeRenderTypes.enableTextTextureLinearFiltering, () -> false))
