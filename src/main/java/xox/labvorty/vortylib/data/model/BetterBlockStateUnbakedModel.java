...
public class BetterBlockStateUnbakedModel extends MultiVariant {
    ...
    @Override
    public @Nullable BakedModel bake(@NotNull ModelBaker modelBaker, @NotNull Function<Material, TextureAtlasSprite> spriteGetter, @NotNull ModelState state, @NotNull ResourceLocation resourceLocation) {
        if (this.getVariants().isEmpty()) {
            ...
            for(Variant modelState : this.getVariants()) {
                BakedModel bakedmodel = modelBaker.bake(modelState.getModelLocation(), modelState, spriteGetter);
