...
import xox.labvorty.vortylib.gui.screen.ItemListScreen;
import xox.labvorty.vortylib.gui.widget.ThemedButton;

import java.util.ArrayList;
import java.util.List;

public class ListConfigEntry extends ConfigEntry<List<String>> {
    private final ModConfigSpec.ConfigValue<List<? extends String>> configValue;
    private ThemedButton widgetButton;

    public ListConfigEntry(Component label, ModConfigSpec.ConfigValue<List<? extends String>> configValue, List<String> defaultValue) {
    ...
    public AbstractWidget createWidget(int x, int y, int width, int height) {
        widgetButton = ThemedButton.builder(Component.literal("Edit"), b ->
                        Minecraft.getInstance().setScreen(new ItemListScreen(this)))
